...
interface Iprops{
    data:Idata[];
    oncourseClick: (course: Idata) => void;
}
/*
 {data.map((courses) =>(
...
*/
const All_courses : React.FC<Iprops> = ({ data , oncourseClick}) => {
        ...
        <div >
            ...
            <p className="listofcourses">
                <img src={logo} className="img-course"/>
                    ...
                    <div className="add_cart" key={courses.id} onClick={() => oncourseClick(courses)}><button>ADD TO CART</button></div>
